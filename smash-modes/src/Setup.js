    ...
    <Form id="setup">
      <Form.Group>
        ...
        <FormControl
          ...
          onChange={e => {
            ...
            setMaxBattles(e.target.value);
          }}
        >
          {_.range(1, absoluteMax).map((val, i) => (
      ...
      <Form.Row>
        <Form.Group as={Col}>
          ...
          <FormControl value={name1} onChange={e => setName1(e.target.value)} />
        </Form.Group>
        <Form.Group as={Col}>
          <Form.Label>P2's name</Form.Label>
          <FormControl value={name2} onChange={e => setName2(e.target.value)} />
        </Form.Group>
      </Form.Row>
      <Form.Group>
        <Form.Check
